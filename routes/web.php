...
Route::middleware(['auth', 'role:3'])->group(function () {
    ...
    Route::get('/empleado/asistenciasR', [EmpleadoController::class, 'asistenciasR'])->name('empleado.asistenciasR');
    Route::post('/empleado/store', [EmpleadoController::class, 'storeAsistencias'])->name('empleado.registrar');
});
});
