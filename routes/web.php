...
Route::get('/dashboard', function () {//todo esto va a ser para admin necesito agregar los roles***************agrege un yield  en el app para separar los contenidos de cada uno
